...
<dom-module id="home-app">
            ...
            <app-toolbar>
                <div class="left-bar-item">
                    <paper-icon-button
                        ...
                        aria-label="toggle drawer menu"></paper-icon-button>
    ...
    <script>
    // performance logging
    window.performance && performance.mark && performance.mark('home-app - before register');
    Polymer({
      is: 'home-app',
      properties: {
        page: {
      ...
      created: function() {
        window.performance && performance.mark && performance.mark('home-app.created');
